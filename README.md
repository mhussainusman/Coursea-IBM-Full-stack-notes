...
## Coursera | IBM | HEC-DLSEI Program

## About
This repository contains my notes and progress for the IBM Full Stack 
Software Developer Professional Certificate completed via Coursera 
under the HEC Digital Skills program.

## Goal
Complete all 13 courses in 6 weeks — June to August 2026

## Course Progress
| # | Course | Status |
|---|--------|--------|
| 1 | Introduction to Software Engineering | ✅ Done |
| 2 | Introduction to Cloud Computing | 🔄️ In Progress |
...
Django | SQL | Docker | Kubernetes | Git | GitHub | Cloud Computing
